...
const Create = ({ marketplace, nft }) => {
  ...
  //       const url = `https://linhaishe-infura.infura-ipfs.io/ipfs/${result.path}`;

  //       console.log(11, result);
  //       console.log(22, url);
  //       // setImage(`https://ipfs.infura.io:5001/api/v0/cat?arg=${result.path}`);
  //     } catch (error) {
  ...
  const mintThenList = async (result) => {
    ...
    const id = await nft.getNextTokenId();
